	...
	\begin{solution}
		...
		$V_{OC}\approx0.77V$
		\newline
		5. At room temperature V$_{OC}$ is 303 mV and at hand temperature it is 433 mV.
	\end{solution}
	\clearpage
	\begin{problem}
	...
	\begin{solution}
		...
		$V_{N}=14.27V$, $R_{N}=2.27k\Omega$, $I_{N}=6.28mA$
		\newline
		4.
	\end{solution}
	\clearpage
	...
	\begin{solution}
		...
		So by knowing $R_{TH}$ to be 2.27k$\Omega$:		
		\newline
		2.
		\newline
		3.
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.5\textwidth]{images/plot233.png}
		\end{figure}
	\end{solution}